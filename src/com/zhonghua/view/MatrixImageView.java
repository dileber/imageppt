 ...
 */
public class MatrixImageView extends NetworkImageView {
    ...
    public void setOnMovingListener(PPTViewPage myViewPager){
        OnMovingListener listener = myViewPager;
    ...
    private class  GestureListener extends SimpleOnGestureListener{
        ...
        public boolean onDown(MotionEvent e) {
            //捕获Down事件
//            L.w("tag",">>>>>>>",e.getPointerCount(),e.getAction(),e.getEventTime()-e.getDownTime());
//
